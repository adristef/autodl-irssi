...
use constant {
	AUTODL_UPDATE_URL => 'https://api.github.com/repos/adristef/autodl-irssi/releases/latest',
	TRACKERS_UPDATE_URL => 'https://api.github.com/repos/adristef/autodl-trackers/releases/latest',
...
sub _parseAutodlUpdate {
	...
	$autodlVersion =~ s/.*v//;
	my $autodlDownloadUrl = "https://github.com/adristef/autodl-irssi/releases/download/$autodlTagName/autodl-irssi-v$autodlVersion.zip";
...
sub _parseTrackersUpdate {
	...
	$trackersVersion =~ s/.*v//;
	my $trackersDownloadUrl = "https://github.com/adristef/autodl-trackers/releases/download/$trackersTagName/autodl-trackers-v$trackersVersion.zip";
